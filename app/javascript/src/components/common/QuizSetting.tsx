  ...
  return (
    <section id="quiz-setting" className="m-2 border p-2">
      ...
      <input
        ...
        onChange={e => filterOutNegativeNumber(setNegativeMark, e.currentTarget.valueAsNumber)}
      />
      ...
      <div>
        <p>
          This Quiz will have <b className="text-green-500">{correctMark} marks awarded</b> for every
          correct correct answer.
          {negativeMarking ? (
            <>
               For every wrong answer <b className="text-red-500">{negativeMark} marks will be deducted</b>
              .
            </>
          ) : (
            ''
